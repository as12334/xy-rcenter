curl = {
    ...
    paths : {
        ...
        popup : 'dialog/popup',
        dialogConfig : 'dialog/dialog-config',
        dialogPlus : 'dialog/dialog-plus',
        drag : 'dialog/drag',
        ...
        validate : 'lotterybox/common/jquery.validate.extend.js',
        validateExtend : 'lotterybox/common/jquery.validate.extend.extend.js',
        ...
        jqcontextify:'jquery/plugins/jquery.contextify/jquery.contextify',
        jqmetisMenu : {
        ...
        spinner : {
            location: 'jquery/plugins/jquery.spinner/jquery.spinner',
            config: {
                loader: 'curl/curl/loader/legacy',
                exports: '$.fn.spinner',
                requires: [ 'jquery']
