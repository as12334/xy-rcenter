define([], function () {
    ...
    return Class.extend({
        ...
        processOrderColumnTag: function (page, form) {
            ...
            _this.targetPage.bindSelectChange($("input[name='paging.pageSize']",_this.formSelector), function (e) {
                e.goType = -2;
                e.page = _this.targetPage;
                _this.gotoPage(e);
            });
            _this.targetPage.bindSelectChange($("select[name='paging.pageSize']",_this.formSelector), function (e) {
                e.goType = -2;
                e.page = _this.targetPage;
                _this.gotoPage(e);
            });
