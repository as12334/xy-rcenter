define(['common/BaseListPage', 'common/Pagination', 'bootstrapswitch'], function (BaseListPage, Pagination) {
    var _this = this;
    return BaseListPage.extend({
        ...
        init: function (formSelector) {
            this.formSelector = "#shareHolderDomainForm";
        ...
        bindEvent: function () {
            ...
            $(_this.formSelector).on("click", "table tbody input[type=checkbox]", function (e) {
            ...
            $("a", "#two-detail",_this.formSelector).on("click", function () {
                ...
                window.top.topPage.ajax({
                    ...
                    success: function (data) {
                        $("form",_this.formSelector).attr("action", afentUrl);
                        $("div.search-list-container",_this.formSelector).html(data);
                        page.onPageLoad();
                        $("div.tab-center",_this.formSelector).css("display", "block");
                        _this.initSwitch();
                    }
                });
