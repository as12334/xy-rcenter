define(['common/BaseListPage','bootstrapswitch'], function (BaseListPage) {
    return BaseListPage.extend({
        ...
        init: function (formSelector) {
            this.formSelector = "#mainFrame #shareholderForm";
                    ...
                    window.top.topPage.showConfirmMessage(msg, function (bol) {
                        if (bol) {
                            ...
                            window.top.topPage.ajax({
                                type: "POST",
                                url: root + "/boss/account/shareholder/updateStatus.html",
                                data: {'result.id': $(event.currentTarget).val()},
                                dataType: 'json',
                                eventTarget:{currentTarget: event.currentTarget},
                                eventCall: eventCall = function (event) {
        ...
        showAuthenticationKeyUrl: function (e, opt) {
            ...
            if (opt.data.state) {
                ...
                var url = root + "/boss/account/shareholder/showAuthenticationKeyUrl.html?username=" + username + "&host=" + host + "&secret=" + secret;
